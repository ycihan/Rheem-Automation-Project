...
Feature: Speak to a specialist pop-up
  ...
  Scenario Outline: testing the specialist
    ...
    Examples:
      ...
      | ali       | can      | Page        | page@info.com  | toys     | asdfgh        | Premium          | Tanks          | Hospitality | ROI          | test test text test |
      | veli      | can      | Paper       | paper@info.com | horse    | 123457        | Standard         | Solar          | F&B         | Others       | test test text test |